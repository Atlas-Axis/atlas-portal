...
//   if (validAt) console.warn('validAt flag is currently unsupported and will be ignored');

//   let atlasPagesPerDatabase = await loadAtlasFromSupabaseWithNestingAgentsUnderSection(); // ? await loadAtlasFromSupabasePastVersion(validAt)
...
//   if (skipAgentScope) {
//     atlasPagesPerDatabase = filterAgentScopeOnlyDescendants(atlasPagesPerDatabase);
//   }
