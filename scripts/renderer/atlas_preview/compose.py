...
# ---------------------------------------------------------------------------
# Source: the Atlas content repo's sync/compose.py module.
# This file is a byte-for-byte port of upstream so it can be updated by
# refreshing the copy rather than incremental edits.
# ---------------------------------------------------------------------------
